...
public class TestValues {
    ...
    public static final int TEST_BEAN_DO_ACTION_ARG = 1;
    public static final int TEST_BEAN_DO_ACTION_RESULT = 2;

    public static final String BUSINESS_KEY_NAME = "businessKey";
    ...
    public static final String CLASS_NAME_VARIABLE_EXPRESSION = "getClassName()";

    public static final String TEST_DELEGATE_FIRST_NAME = "firstDelegate";
    public static final String TEST_DELEGATE_SECOND_NAME = "secondDelegate";
    public static final String TEST_DELEGATE_THIRD_NAME = "thirdDelegate";
